...
window.addEventListener('scroll',()=>{sections.forEach(s=>{let top=s.getBoundingClientRect().top;if(top<window.innerHeight-150){s.style.opacity=1;s.style.transform='translateY(0)';}else{s.style.opacity=0;s.style.transform='translateY(50px)';}});});
